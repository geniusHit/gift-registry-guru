...
const languageSettingDATA = {
    addToWishlist: "Add to registry",
    addedToWishlist: "Remove from registry",
    removeFromWishlist: "Remove from registry",
    addToCart: "Move to cart",
    addAllToCart: "Add all items to cart",
    viewCart: "View cart",
    noMoreItem: "Your wishlist is empty",
    addToWishlistNotification: "Item has been added to registry",
    removeFromWishlistNotification: "Item has been removed from registry",
    shareYourWishlist: "Share",
    alertForRemoveButton: "Item removed from the registry",
    alertForAddToCartButton: "Item added to cart",
    modalHeadingText: "Your registry",
    textForGridIcon: "View as:",
    sharableLinkModalHeading: "You can share your registry through this link..!",
    alertForLinkCopied: "Link copied ",
    sharedPageHeading: "registry Items",
    addToMyWishlist: "Add to my registry",
    addToMyCart: "Move to my cart",
    sharedPageItemAdded: "Item added to your registry",
    sharedPageAlreadyAdded: "Item already added to your registry",
    ...
    shareWishlistByEmailSuccessMsg: "Your registry has been sent",
    ...
    loginTextForWishlist: "Registry is not saved permanently yet. Please",
    ...
    quotaLimitAlert: "Registry Quota of this store reached its monthly limit, We have notified store owner to upgrade their plan. Sorry for the inconvenience",
    alertAddAllToCart: "All Items are added to cart",
    headerMenuWishlist: "Registry",
    isLoginParaText: "You need to login first to create and save your registry",
    clearAllWishlist: "Clear registry",
    shareWishlistRecieverName: "Reciever Name",
    shareWishlistMessagePlaceholder: "Write a message here..",

    createWishlistHeading: "Create registry",
    createBtn: "Create list",
    saveWishlistBtn: "Save registry",
    copyHeading: "Copy to",
    editWishlistHeading: "Edit registry Name",
    editBtn: "Update list",
    copyBtn: "Copy",
    deleteMsg: "Are you sure, you want to delete this registry",
    deleteYesBtn: "Yes delete",
    deleteNoBtn: "Cancel",
    clearWishlist: "Clear registrys",
