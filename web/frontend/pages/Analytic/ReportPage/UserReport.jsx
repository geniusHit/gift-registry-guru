...
import {
    Page, Spinner, LegacyCard, IndexTable, Pagination, Button, Text, Icon, Select,
    IndexFilters, Modal,
    useSetIndexFiltersMode,
    IndexFiltersMode, DatePicker, Box,
    Grid
...
const WishlistUser = ({ myLanguage, requestBody, selectedValue, selectedOption, options, setIsCount }) => {
    ...
    const userListTable = userList.map(
        ({ id, email, user_type, created_at, cartTableCount, wishlistItemCount },) => [
            <IndexTable.Row id={id} key={id} position={id} >
                ...
                <Box className='show-less-text' ><IndexTable.Cell>{email}</IndexTable.Cell></Box>
                ...
                <IndexTable.Cell><Button onClick={() => viewHandler(id)}><Icon source={ViewIcon} color="base" /></Button></IndexTable.Cell>
            </IndexTable.Row>
        ],
    );
    ...
    return (
        <Box dir={wishlistTextDirection} className='wf-userReport'>
            <Page>
                <Modal
                    open={active}
                ...
                <Box className='wf-listingRecord'>
                ...
                <Box className='customer-recently-table'>
                    {
                        loaderMain ?
                            <Box style={{ textAlign: 'center' }}><Spinner accessibilityLabel="Spinner example" size="large" />
                            </Box>
                            :
                            <LegacyCard>
                                <IndexFilters
                                ...
                                <Box className='polaris_pagination'>
                                    <Pagination
                                        onPrevious={() => {
