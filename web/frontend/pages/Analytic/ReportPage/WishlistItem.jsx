...
const WishlistItem = ({ myLanguage, requestBody, selectedValue, selectedOption, options, setIsCount }) => {
    ...
    async function checkGetAllItem(res) {
        try {
            const userData = await fetch(`${serverURL}/get-wishlist-Item-data`, {
                method: "POST",
                headers: {
    ...
    const filteredAndSortedData = useMemo(() => {
        ...
        return filteredData;
    }, [mainData, queryValue, sortSelected, isClicked, listingPerPage, listPg]);
            ...
            <Page>
                ...
                <div className='wf-listingRecord'>
                    <div className='wf-listingRecord-inner'>
                        ...
                        <p>{myLanguage.wishlistItemsText}</p>
                    </div>
