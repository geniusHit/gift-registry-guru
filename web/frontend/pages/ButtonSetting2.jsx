...
//                     // hoverFontSize: dData.hover.fontSize.value,
//                     // hoverFontSizeUnit: dData.hover.fontSize.unit,
//                     cartButtonbgColor: dData.cartButtonStyle.bgColor,
//                     cartButtonborderInput: dData.cartButtonStyle.border.value,
//                     cartButtonborderInputUnit: dData.cartButtonStyle.border.unit,
//                     cartButtonborderRadius: dData.cartButtonStyle.borderRadius.value,
//                     cartButtonborderRadiusUnit: dData.cartButtonStyle.borderRadius.unit,
//                     cartButtonborderType: dData.cartButtonStyle.border.type,
//                     cartButtonborderColor: dData.cartButtonStyle.border.color,
//                     cartButtonfontFamily: dData.cartButtonStyle.fontFamily,

//                     cartButtonfontWeight: dData.cartButtonStyle.fontWeight,

//                     cartButtonfontSize: dData.cartButtonStyle.fontSize.value,
//                     cartButtontextColor: dData.cartButtonStyle.textColor,
//                     cartButtonfontSizeUnit: dData.cartButtonStyle.fontSize.unit,
//                     cartButtonnborderColor: dData.cartButtonStyle.border.color,
//                     cartButtonhover: dData.cartButtonStyle.hover.hoverValue,
//                     cartButtonhoverBgColor: dData.cartButtonStyle.hover.bgColor,
//                     cartButtonhoverBorderColor: dData.cartButtonStyle.hover.border.color,
...
//                     cartButtonhoverTextColor: dData.cartButtonStyle.hover.textColor,
//                     cartButtonhoverFontSize: dData.cartButtonStyle.hover.fontSize.value,
//                     cartButtonhoverFontSizeUnit: dData.cartButtonStyle.hover.fontSize.unit,
//                     cartButtonmarginLeftRight: dData.cartButtonStyle.marginLeftRight.value,
//                     cartButtonmarginLeftRightUnit: dData.cartButtonStyle.marginLeftRight.unit,
//                     cartButtonmarginTopBottom: dData.cartButtonStyle.marginTopBottom.value,
//                     cartButtonmarginTopBottomUnit: dData.cartButtonStyle.marginTopBottom.unit,
//                     cartButtonpaddingLeftRight: dData.cartButtonStyle.paddingLeftRight.value,
//                     cartButtonpaddingLeftRightUnit: dData.cartButtonStyle.paddingLeftRight.unit,
//                     cartButtonpaddingTopBottom: dData.cartButtonStyle.paddingTopBottom.value,
//                     cartButtonpaddingTopBottomUnit: dData.cartButtonStyle.paddingTopBottom.unit,
...
//         let dataSubmit = {
//             wishlistButtonCheck: true,
//             type: data.buttonTypeRadio,
//             iconColor: { filterColor: iconColor.color, color: data.iconColor },
//             iconType: data.iconType,
//             animationType: data.animationType,
//             bgColor: data.bgColor,
//             textColor: data.textColor,
//             fontSize: { value: data.fontSize, unit: data.fontSizeUnit },
//             buttonTypeRadio: data.buttonTypeRadio,
...
//             width: { value: data.widthValue, unit: data.widthUnit },
//             border: {
...
//                     iconColor: cartButtoniconColorHover.color,
//                     border: {
...
//             // },
//             // iconBesideTitle: data.iconBesideTitle,
//             // iconBesideAddToCart: data.iconBesideAddToCart,
...
//             if (data.iconType !== collectionData.current.iconType) {
