            ...
            <IndexTable.Row id={lang_id} key={lang_id} position={lang_id} >
                ...
                <IndexTable.Cell>
                    <div className='wf-store-btns'>
                        <Button onClick={() => handleEditModal(lang_id, url_id)}><Icon source={EditIcon} color="base" /></Button>
                        {
                            type !== "default" &&
                            <Button onClick={() => hanldleDeleteLang(lang_id, url_id, lang_name)}><Icon source={DeleteIcon} tone="base" /></Button>
                        }
