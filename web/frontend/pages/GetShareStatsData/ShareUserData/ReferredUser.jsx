...
const ReferredUser = ({ myLanguage, requestBody, selectedValue, selectedOption, options, setIsCount }) => {
    ...
    async function checkGetAllItem(res) {
        try {
            const userData = await fetch(`${serverURL}/get-share-stats-users-data`, {
                method: "POST",
                headers: {
            ...
            <Page>
                ...
                <div className='wf-listingRecord'>
                    <div className='wf-listingRecord-inner'>
                        <Text variant="headingLg" as="h2">{myLanguage.statsReportHeading}</Text>
                        <p>{myLanguage.statsReportHeadingSubHeadig}</p>
                    </div>
